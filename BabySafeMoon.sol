...
//
// $BSM proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN Safemoon! With the auto-claim feature,
// simply hold$BSM and you'll receive SafeMoon automatically in your wallet.
// 
// Hold Baby SafeMoon and get rewarded in SafeMoon on every transaction!
//
//
// 📱 Telegram: https://t.me/babysafemoon_Official
// 🌎 Website: https://www.babysafemoon.app/
// 🌐 Twitter: https://twitter.com/babysafemoon2
...
contract BSM is ERC20, Ownable {
    ...
    BSMDividendTracker public dividendTracker;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    address public immutable SAFEMOON = address(0x8076C74C5e3F5852037F31Ff0093Eeb8c8ADd8D3); //SAFEMOON

    uint256 public swapTokensAtAmount = 2000000 * (10**18);
    mapping(address => bool) private _isExcludedFromMaxTx;
    mapping(address => bool) public _isBlacklisted;

    uint256 public SAFEMOONRewardsFee = 8;
    ...
    constructor() public ERC20 ("BABY SAFEMOON", "BSM") {

    
    	dividendTracker = new BSMDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        BSMDividendTracker newDividendTracker = BSMDividendTracker(payable(newAddress));
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BABYSAFEMOON: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BABYSAFEMOOON: Automated market maker pair is already set to that value");
...
contract BSMDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("BSM_Dividen_Tracker", "BSM_Dividend_Tracker") {
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "BSM_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "BSM_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BABYSAFEMOON contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BSM_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BSM_Dividend_Tracker: Cannot update claimWait to same value");
